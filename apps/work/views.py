...
class WorkList(FilterView):
    ...
    def get_context_data(self, **kwargs):
        ...
        list_description_empty_filter = Q(list_description__isnull=True) | Q(list_description='')
        work_with_list_description = Work.objects.exclude(list_description_empty_filter)
        work_with_no_list_description = Work.objects.filter(list_description_empty_filter)
